    ...
    <main className="flex flex-col items-center justify-center min-h-screen px-6 py-16 md:px-10 bg-gradient-to-b from-white to-blue-50 dark:from-gray-900 dark:to-gray-950 text-center">
      ...
      >
        ...
        <p className="text-base md:text-lg text-gray-600 dark:text-gray-300 mb-10 leading-relaxed">
          A <span className="font-semibold text-blue-600">Frontend Engineer</span> &
          <span className="font-semibold text-blue-600"> Fullstack Developer</span> committed to writing clean code, applying clean architecture principles, and delivering high-performance web applications with elegant user experiences.
        </p>
